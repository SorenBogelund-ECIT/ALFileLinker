@{
    ...
    PrivateData = @{
        PSData = @{
            ...
            ReleaseNotes = 'Removed .git/info/exclude management. Set-ALFileLinks now cleans up old ALFileLinker entries from .git/info/exclude and automatically stages linked files for git tracking.'
        }
    }
}
